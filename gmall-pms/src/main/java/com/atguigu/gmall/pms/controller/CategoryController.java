...
public class CategoryController {
    ...
    public ResponseVo<List<CategoryEntity>> queryCategoryList(@PathVariable("parentId")Long parentId){
        List<CategoryEntity> categoryList = categoryService.queryCategoryList(parentId);
